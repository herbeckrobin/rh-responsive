...
/**
 * GitHub-basierter Auto-Update-Checker für rh-responsive. Zieht das Release-ZIP aus den
 * GitHub Releases (Tags `v*`), inkl. gebundeltem Core und plugin-update-checker.
 */
final class UpdateChecker
{
    public const GITHUB_REPO = 'https://github.com/herbeckrobin/rh-responsive/';
    public const PLUGIN_SLUG = 'rh-responsive';
